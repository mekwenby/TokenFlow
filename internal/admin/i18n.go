...
var translations = map[string]map[string]string{
	"en": {
		...
		"overview":                "Overview",
		"more":                    "More",
		"admin_navigation":        "Admin sections",
		"more_navigation":         "More admin sections",
		...
		"cache_read_price":        "Cache read $/1M",
		"cache_creation_price":    "Cache write $/1M",
		"unpriced":                "Unpriced",
		...
		"invalid_price":           "model prices must be non-negative",
	...
	"zh-CN": {
		...
		"overview":                "概览",
		"more":                    "更多",
		"admin_navigation":        "管理后台分区",
		"more_navigation":         "更多管理分区",
		...
		"input_price":             "输入 $/1M",
		"output_price":            "输出 $/1M",
		"cache_read_price":        "缓存读取 $/1M",
		"cache_creation_price":    "缓存写入 $/1M",
		"unpriced":                "未定价",
		"unpriced_models":         "未定价模型",
