...
var translations = map[string]map[string]string{
	"en": {
		...
		"users":                   "Users",
		"email":                   "Email",
		"quota_total_tokens":      "Quota",
		"quota_used_tokens":       "Used quota",
		"quota_remaining_tokens":  "Remaining",
		"consumer_user":           "User",
		"recent_requests":         "Recent requests",
		"logs_search":             "Search requests",
		"logs_search_placeholder": "User / key / provider / model",
		"requests":                "Requests",
		...
		"invalid_detail_scope":    "scope must be provider, key, or user",
	...
	"zh-CN": {
		...
		"users":                   "用户",
		"email":                   "邮箱",
		"quota_total_tokens":      "额度",
		"quota_used_tokens":       "已用额度",
		"quota_remaining_tokens":  "剩余额度",
		"consumer_user":           "用户",
		...
		"invalid_detail_scope":    "scope 必须是 provider、key 或 user",
		"detail_id_required":      "id 不能为空",
		"unsupported_language":    "不支持的语言",
		"provider_select_empty":   "请先创建供应商。",
		"invalid_user_status":     "status 必须是 pending、enabled 或 disabled",
	},
}
